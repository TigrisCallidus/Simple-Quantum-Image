...
[CustomEditor(typeof(LightningController))]
...
public class LightningControllerEditor : Editor {
    ...
    LightningController targetScript;
    ...
    public override void OnInspectorGUI() {
        ...
        if (GUILayout.Button("Apply Background Settings")) {
            targetScript.SetBackgroundSettings();
        }
